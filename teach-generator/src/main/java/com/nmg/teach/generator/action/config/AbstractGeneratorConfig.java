...
import com.nmg.teach.core.util.FileUtil;
import com.nmg.teach.generator.engine.SimpleTemplateEngine;
import com.nmg.teach.generator.engine.base.TeachTemplateEngine;
import com.nmg.teach.generator.engine.config.ContextConfig;
import com.nmg.teach.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doAdiGeneration() {
        TeachTemplateEngine teachTemplateEngine = new SimpleTemplateEngine();
        teachTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        teachTemplateEngine.setSqlConfig(sqlConfig);
        teachTemplateEngine.setTableInfo(tableInfo);
        teachTemplateEngine.start();
    }
}
