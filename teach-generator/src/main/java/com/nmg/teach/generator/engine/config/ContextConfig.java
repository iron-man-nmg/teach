package com.nmg.teach.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "teachTemplate/advanced";
    ...
    private String proPackage = "com.nmg.teach.admin";
    private String coreBasePackage = "com.nmg.teach.core";
    private String modelPackageName = "com.nmg.teach.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.nmg.teach.admin.common.persistence.dao";  //model的dao
