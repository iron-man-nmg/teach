...
public class TeachFlowableProperties {
    ...
    //默认多数据源的链接
    private String url = "jdbc:mysql://120.79.151.158:3306/teach_flowable?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
