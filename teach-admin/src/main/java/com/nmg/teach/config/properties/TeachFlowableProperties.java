...
public class TeachFlowableProperties {
    ...
    //默认多数据源的链接
    private String url = "jdbc:mysql://122.152.221.242:3306/teach_flowable?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
