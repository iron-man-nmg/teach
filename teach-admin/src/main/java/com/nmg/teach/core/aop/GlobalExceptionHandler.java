package com.nmg.teach.core.aop;

import com.nmg.teach.common.exception.BizExceptionEnum;
import com.nmg.teach.common.exception.InvalidKaptchaException;
import com.nmg.teach.core.base.tips.ErrorTip;
import com.nmg.teach.core.exception.TeachException;
import com.nmg.teach.core.log.LogManager;
import com.nmg.teach.core.log.factory.LogTaskFactory;
...
public class GlobalExceptionHandler {
     ...
     * @author xiadingli
     */
    @ExceptionHandler(TeachException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ErrorTip notFount(TeachException e) {
