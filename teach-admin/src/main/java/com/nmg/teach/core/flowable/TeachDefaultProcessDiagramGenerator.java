...
package com.nmg.teach.core.flowable;
 ...
 */
public class TeachDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public TeachDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public TeachDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
