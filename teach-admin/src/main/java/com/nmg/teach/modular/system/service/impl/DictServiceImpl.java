...
import com.nmg.teach.modular.system.dao.DictDao;
import com.nmg.teach.modular.system.service.IDictService;
import com.nmg.teach.common.persistence.dao.DictMapper;
...
import static com.nmg.teach.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if(dicts != null && dicts.size() > 0){
            throw new TeachException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new TeachException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
