package com.nmg.teach.modular.code.factory;


import com.nmg.teach.TeachApplication;
import com.nmg.teach.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("nmg");
        genQo.setProjectPackage(TeachApplication.class.getPackage().getName());
