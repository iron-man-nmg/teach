...
import com.nmg.teach.common.constant.dictmap.MenuDict;
import com.nmg.teach.common.constant.factory.ConstantFactory;
import com.nmg.teach.common.constant.state.MenuStatus;
import com.nmg.teach.common.exception.BizExceptionEnum;
import com.nmg.teach.common.persistence.dao.MenuMapper;
...
import com.nmg.teach.core.support.BeanKit;
import com.nmg.teach.core.util.ToolUtil;
import com.nmg.teach.modular.system.dao.MenuDao;
import com.nmg.teach.modular.system.service.IMenuService;
import com.nmg.teach.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new TeachException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new TeachException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
