package com.nmg.teach.core.mutidatasource.aop;

import com.nmg.teach.core.mutidatasource.DataSourceContextHolder;
import com.nmg.teach.core.mutidatasource.annotion.DataSource;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.nmg.teach.core.mutidatasource.annotion.DataSource)")
    private void cut() {
